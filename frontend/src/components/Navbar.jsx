...
export default function Navbar() {
  ...
  text-white px-6 md:px-12 py-3 flex items-center justify-between shadow-md"
    >
      {/* Logo + Text */}
      <div className=" w-50 md:w-78 h-25 flex items-center space-x-4 min-w-[120px]">
      ...
      <ul className="hidden md:flex space-x-8 font-medium text-xl">
        ...
        <li>
          <a href="#whatwedo" className="hover:text-blue-400 transition">
            What We Do
          </a>
        </li>
      </ul>
      ...
      {isOpen && (
        <div className="absolute top-16 left-0 w-full bg-black text-center md:hidden py-6 space-y-4 z-50">
          ...
          <a href="#brands" className="block hover:text-yellow-400 transition">
            Brands
          </a>
          <a
            href="#services"
          ...
          <a href="#process" className="block hover:text-yellow-400 transition">
            Process
          </a>
          <a
            href="#whatwedo"
